...
| `report.html` | 가나안 정탐 보고서 모음(발표용) — 6개 조 미션1 사진+미션2 3항목(승인된 것만) 보고서를 여호수아 서사 톤으로 모아 보여줌. 화면으로 바로 보거나 "📄 PDF로 저장"으로 다운로드 가능(html2canvas+jsPDF), 인쇄 버튼도 백업으로 있음 | 전체 교사·발표 진행자 (인증 없음) |
