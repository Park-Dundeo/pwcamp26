...
| `guide.html` | 견학 코스 안내(웹) — `견학교육문서.md` 내용을 코스 A/B/C 탭으로 웹에서 바로 볼 수 있게 만든 페이지. `?course=a/b/c`로 특정 코스 바로 열기 가능 | 전체 교사·학생 |
...
- 미구현으로 남은 것 없음 — 비밀번호 해금 직후 인트로 내레이션도 REQ-09 범위 확장분으로 반영 완료 (2026-07-08)
