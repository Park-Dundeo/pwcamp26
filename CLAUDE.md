...
- **2026-07-09 견학지 재편 (REQ-37):** 견학지가 3곳→2곳으로 축소됨(연세대 언더우드가 기념관 보류). 현재 배정은 **1·2·3조 = 전쟁기념관(경유지 각각 노들섬/이촌한강공원/서울로7017), 4·5·6조 = 서대문형무소(경유지 성수역, 3개 조 공통 임시)**. 전쟁기념관행은 대화에서 "전쟁 1조/2조/3조"로 표기된 걸 캠프 팀번호 1/2/3조로 그대로 해석한 것이라 확인 필요. 서대문형무소행 3개 조의 개별 경유지는 아직 미확정.
